...
<div class="container">
    ...
    <form method="POST" action="index.php?action=add">
        <div class="form-group">
            ...
            <input type="text" id="name" name="name" value="<?= htmlspecialchars($name ?? '') ?>" placeholder="Nhập họ tên sinh viên">
        </div>
        <div class="form-group">
            <label for="major">Ngành học:</label>
            <input type="text" id="major" name="major" value="<?= htmlspecialchars($major ?? '') ?>" placeholder="Nhập ngành học">
        </div>
        <div class="btn-group">
